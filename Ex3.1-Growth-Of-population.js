 ...
 */
 ...
 /**
 * @param {number} p0 -  population at the beginning of a year
 * @param {number} percent - population increase percent per year (x = x%)
 * @param {number} aug - inhabitants coming or leaving each year
 * @param {number} p - population to surpass
 * @return {number} totalYears - number of entire years needed to get a population greater or equal to p.
 */
